...
import { Tabs, InputNumber, Form, Collapse, Select, Icon, Steps, Button, DatePicker, message } from 'antd'
            ...
            <Collapse className="ant-advanced-search-panel-collapse" >
                <Panel header="Search" key="1">
                    <Form onSubmit={this.handleSearch}>
                        <Row gutter={2}>
                            <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 8 }} lg={{ span: 8 }} xl={{ span: 8 }} style={{ marginTop: '0' }}>
                                <FormItem  {...formItemLayout} style={{ marginBottom: 0 }} label="Stk">
                                    {getFieldDecorator('stk', {}, {})(
                                        <Input />,
                                    )}
                                </FormItem>
                            </Col>
                            <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 8 }} lg={{ span: 8 }} xl={{ span: 8 }} style={{ textAlign: 'left' }}>
                        ...
                        <Row gutter={2}>
                            <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 8 }} lg={{ span: 8 }} xl={{ span: 8 }}>
                                <FormItem {...tailFormItemLayout}>
                                    ...
                                    <Button icon="sync" size={button_size} style={{ marginLeft: 8 }} onClick={this.handleReset} >Clean</Button>
                                </FormItem>
                            </Col>
                        </Row>
                    </Form>
