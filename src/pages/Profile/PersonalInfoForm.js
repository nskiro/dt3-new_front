                ...
                <Form layout="horizontal" onSubmit={this.props.onSubmit}>
                    ...
                    <FormItem label="New Password" {...formItemLayout}>
                        {getFieldDecorator('password', {
                            rules: [{ required: true, message: 'Please input new pasword!' },{min: 6,message: 'Password length must be greater than 5 characters' }],
                        })(<Input type="password" />)}
                    </FormItem>
                        ...
                        {getFieldDecorator('password2', {
                            rules: [
                                { required: true, message: 'Confirm your new password' },
                                {
                                    ...
                                    validator: (rule, value, cb) => (value === getFieldValue('password') ? cb() : cb(true))
                                }]
                        })(<Input type="password" />)}
                    </FormItem>
