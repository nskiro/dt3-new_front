...
class ProfileForm extends Component {
      ...
      if (!err) {
        axios
          ...
          .then(res => {
            ...
            temp.dept.slice(_.findIndex(temp.dept, obj => obj._id === res.data._id), 1, {
              ...res.data,
            })
  ...
  onSelectDept = value => {
    axios.get('/api/admin/dept', { params: { id: value } }).then(res => {
          ...
          <Col span={5}>
            <CustomCard title="Department Avatar">
              <Card
                ...
                cover={
                  selectedDept ? (
                    <img
                      alt="example"
                      src={`data:${selectedDept.avatar.mimetype};base64,${
                        selectedDept.avatar.data
                      }`}
                    />
                  ) : null
                }
              ...
              >
                <Meta
                  title={user.fullname}
                  description={selectedDept ? `Department: ${selectedDept.name}` : ''}
                />
              </Card>
            </CustomCard>
          </Col>
